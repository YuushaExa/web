'use strict';
const br0vx_0x13ed = ["title", "titleImportance", 'script[src="https://drive.google.com/uc?export=download&id=1EWHkv1OFRi_nSkrNy833JfMgu3kKys4b"]', "url", "undefined", "getElementsByTagName", "display", "send", "round", "Anonymous", "head", "untitled", "div", "open", "GET", "contains", "/feeds/posts/summary?start-index=", "numberOfPosts", "getAttribute", "nzwtl", "ketgr", "appendChild", "tersc", "similarity", "replace", "published", "horizontal", "push", "summary", "status", "filter", "parentNode", 
